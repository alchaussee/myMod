...
public class SlotCrockpotBlock extends Slot
{

	private EntityPlayer thePlayer;
	private int field_75228_b;
	
	public SlotCrockpotBlock(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
	{
	...
	protected void onCrafting(ItemStack par1ItemStack)
	{
	         ...
	         if (!this.thePlayer.worldObj.isRemote)
	         {
	                 ...
	                 float var3 = RecipiesCrockpot.smelting().getExperience(par1ItemStack);
	                 int var4;
