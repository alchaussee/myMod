...
public class RenderSkewer extends Render
{
    public void renderSkewer(EntitySkewer par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
    {
        this.loadTexture("/myMod/common/skewer.png");
        GL11.glPushMatrix();
    ...
    {
        this.renderSkewer((EntitySkewer)par1Entity, par2, par4, par6, par8, par9);
    }
}
