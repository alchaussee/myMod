...
public class TileEntityCrockpotBlock extends TileEntity implements IInventory, ISidedInventory
{
    ...
    */
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                var2 = true;
                //BlockFurnace.updateCrockpotBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    {
        if (this.furnaceItemStacks[0] == null && this.furnaceItemStacks[2] == null && this.furnaceItemStacks[3] == null && this.furnaceItemStacks[4] == null)
        {
            return false;
        }
        else
        {
            ItemStack var1 = RecipiesCrockpot.smelting().getSmeltingResult(this.furnaceItemStacks[0], this.furnaceItemStacks[2], this.furnaceItemStacks[3], this.furnaceItemStacks[4]);
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            if (this.furnaceItemStacks[0]!=null && this.furnaceItemStacks[0].stackSize <= 0)
            {
                this.furnaceItemStacks[0] = null;
            }
            if (this.furnaceItemStacks[2]!=null && this.furnaceItemStacks[2].stackSize <= 0)
            {
                this.furnaceItemStacks[2] = null;
            }
            if (this.furnaceItemStacks[3]!=null && this.furnaceItemStacks[3].stackSize <= 0)
            {
                this.furnaceItemStacks[3] = null;
            }
            if (this.furnaceItemStacks[4]!=null && this.furnaceItemStacks[4].stackSize <= 0)
            {
